...
export const defaultCharacterElements: CharacterElement[] = [
  {
    ...
    prompt_anchor: "Zach: Early 20s, lean athletic build, toned arms, sharp jawline, youthful smooth skin, bright white straight teeth. Rising from metal tribute tube/glass cylinder on circular launch platform. Cream knit designer sweater, black tactical vest, silver rings. Competitive smirk barely suppressed — chin up, chest forward, scanning opponents with open disdain. Eyes tracking the tribute to his left without turning his head. Right hand adjusting silver rings, left fist clenching at his side — rings catching overcast light. Weight shifted forward on balls of feet, coiled to sprint. Wind catching hair. Cornucopia visible in background. 35mm grit. END FRAME: Close-up of empty cylindrical glass tribute tube with metal base ring on circular stone launch platform, forest treeline behind, overcast teal-orange grading, no people.",
  ...
  },
  {
    ...
    prompt_anchor: "Abby Lee: Mid-50s heavyset woman, harsh weathered face, deep scowl lines, jowly cheeks, thin lips pressed tight. Permobil F5 Corpus motorized wheelchair — black matte frame, articulating footplates, high-back seat, joystick controller on right armrest. Predatory calm — zero fear, zero hesitation. White-knuckle grip on joystick like a throttle, right thumb hovering over boost. Jaw locked, eyes laser-focused on the Cornucopia like it owes her money. Head tilted slightly forward, not back — leaning INTO it. Left hand fingers drumming the armrest with impatient rhythm. Black rhinestoned headband, oversized navy blue tactical vest over black silk blouse, silver chunky necklace. Plastic Starbucks cup in tactical cup holder. Cornucopia and forest treeline visible behind her.",
    visual_logic: "Arena bloodbath aesthetic — NOT a war zone. Wheelchair launched from tribute platform toward Cornucopia. Fireball explosion at arena center engulfing wheelchair. Low-angle emphasizing wheelchair's tank-like presence on grass arena floor. Wheelchair physics: heavy rolling momentum on packed earth, sparks from metal scraping stone platform.",
