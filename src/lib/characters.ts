...
export const defaultCharacterElements: CharacterElement[] = [
  {
    ...
    prompt_anchor: "Zach: Early 20s, lean athletic build, toned arms, sharp jawline, youthful smooth skin, bright white straight teeth. Rising from metal tribute tube/glass cylinder on circular launch platform. Cream knit designer sweater, black tactical vest, silver rings. Diva disgust expression as he surveys the arena. Wind catching hair. Cornucopia visible in background. 35mm grit. END FRAME: Close-up of empty cylindrical glass tribute tube with metal base ring on circular stone launch platform, forest treeline behind, overcast teal-orange grading, no people.",
